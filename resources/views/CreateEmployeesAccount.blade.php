...
<div class="BchangeSB">
    ...
    <button class="tablink" onclick="openPage('Buyer', this, '#80b435')" id="defaultOpen">Nhân Viên</button>
</div>
            ...
            <div class="container container-ver2">
                <div class="content-text space-50">
                    <div class="row">
                        <div class="center">
                            <h2>Tạo tài khoản</h2>
                            <p>Tạo tài khoản nhân viên để góp phần giúp công ty thêm cổ phần hóa ra thị trường thế giới</p>
                        </div>

                        <form id="formbuyer" class="form-horizontal"action="{{route('CreateAccountEmployees')}}" method="POST">
