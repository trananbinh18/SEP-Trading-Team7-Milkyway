      ...
      <aside class="widget widget_product_categories" style="padding-left: 10px;">
        <div class="categories-home3">
             ...
             <ul class="menu-vertical">
              ...
              <li><img src="resources/assets/images/icon-categories-1.png" alt=""><a href="{{route('ListHide')}}" title="Sản phẩm đã ẩn">Danh sách sản phẩm ẩn</a><span class="badge"><?php echo $countHideproduct; ?></span></li>
