...
@section('content')
                        ...
                        @foreach ($sanpham as $pham)
                            <div class="item-inner">
                                <div class="product">
                                    ...
                                    <a href="#" title="Bouble Fabric Blazer"><p class="product-title">{{$pham['TENSP']}}</p></a>
    ...
    var usertype = {{session()->get('typeuser')}};
    var sx = "moi";
    var dm = "0";
    var page = 1;
