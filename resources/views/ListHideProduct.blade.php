          ...
          <aside class="widget widget_product_categories" style="padding-left: 10px;">
            <div class="categories-home3">
              ...
              <ul class="menu-vertical">
                <li><img src="resources/assets/images/icon-categories-1.png" alt=""><a href="{{route('listpro')}}" title="Sản phẩm chờ duyệt">Sản phẩm chờ duyệt</a><span class="badge"><?php echo $countUnapprovedproduct; ?></span></li>
                ...
                <li><img src="resources/assets/images/icon-categories-1.png" alt=""><a href="{{route('ListHide')}}" title="Sản phẩm đã ẩn">Sản phẩm đã ẩn</a><span class="badge">{{count($productHide)}}</span></li>
       ...
       <div class="quick-modal show">
          ...
          <div id="quickview-content">
             <div class="woocommerce product product-details-content">
              ...
              <p>Bạn có đồng ý hiện sản phẩm này ?</p>
                ...
                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                  ...
                  <tbody>
                    ...
                    <tr class="odd gradeX">   
                      ...
                      <td class="center">
                        <a class="linkHien" href="{{ url('QuickShowProduct',[$row->MASP]) }}">Hiện<span aria-hidden="true"></span></a>
                        <span> | </span>
