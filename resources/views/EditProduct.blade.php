                    ...
                    <div class="categories-home3">
                       <h3>Thông tin sản phẩm</h3>
                        ...
                        <ul class="menu-vertical">
                            <li><img src="{{url('resources/assets/images/icon-categories-1.png')}}" alt=""><a href="{{route('listpro')}}" title="">Sản phẩm chờ duyệt</a><span class="badge"><?php echo $countUnapprovedproduct; ?></span></li>
                            <li><img src="{{url('resources/assets/images/icon-categories-1.png')}}" alt=""><a href="{{route('ListApproved')}}" title="">Sản phẩm đã duyệt</a><span class="badge"><?php echo $countApproveproduct; ?></span></li>
                            <li><img src="{{url('resources/assets/images/icon-categories-1.png')}}" alt=""><a href="{{route('ListHide')}}" title="">Sản phẩm đã ẩn</a><span class="badge"><?php echo $countHideproduct; ?></span></li>
