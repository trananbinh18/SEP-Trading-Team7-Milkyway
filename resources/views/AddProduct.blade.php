                    ...
                    <div class="categories-home3">
                       <h3>Thông tin tài khoản</h3>
                        ...
                        <ul class="menu-vertical">
                          ...
                          <li><img src="resources/assets/images/icon-categories-1.png" alt=""><a href="{{route('ListHide')}}" title="">Sản phẩm đã ẩn</a><span class="badge"><?php echo $countHideproduct; ?></li>
